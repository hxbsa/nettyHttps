        ...
        bootstrap.group(ctx.channel().eventLoop())
                ...
                .handler(new ChannelInitializer<Channel>() {
                    ...
                    protected void initChannel(Channel ch) throws Exception {
                        ...
                        ch.pipeline().addLast(new HttpObjectAggregator(10*10*1024));
